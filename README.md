...
Live: **https://invoice.properties** — landlord login `jury@main.nl` / `ILoveCursor`. Two demo buildings; from any statement, "Portal" opens the tenant's view.
Market research (TAM/SAM/SOM, competitors, go-to-market): [Marktpotenzialanalyse_AI_Nebenkostenabrechnung_Deutschland.pdf](Marktpotenzialanalyse_AI_Nebenkostenabrechnung_Deutschland.pdf) in this repository.
